...
Requires: perl-HTML-StripScripts-man
...
%package man
Summary: man components for the perl-HTML-StripScripts package.
Group: Default

%description man
man components for the perl-HTML-StripScripts package.
...
mkdir -p %{_topdir}/BUILD/HTML-StripScripts-1.06/deblicense/
...
%files
%defattr(-,root,root,-)
/usr/lib/perl5/site_perl/5.26.1/HTML/StripScripts.pm
